...
The `node_modules` folders are very large (100MB+) and not needed. They will be recreated by running `npm install`.

### ✅ What to Send

**Option 1: ZIP file (exclude node_modules)**

1. Delete both `node_modules` folders:
   - `fyp-dashboard-modern/node_modules`
   - `fyp-dashboard-modern/server/node_modules`
2. ZIP the remaining files
3. Send the ZIP to your friend
...
# Add files (node_modules already in .gitignore)
git add .
git commit -m "FYP Secure Network System"

# Push to GitHub
git remote add origin https://github.com/YOUR_USERNAME/fyp-secure-network.git
git push -u origin main
```

Your friend can then clone: `git clone <url>`
...
# 3. Set up database (import schema.sql)
# 4. Run the app
```
...
- [ ] ZIP and share OR push to GitHub
